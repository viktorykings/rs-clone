...
const cardType: ICardTypesObj = {
  ...
  en: [
    { name: 'Взрывной котенок', description: '', links: [`${baseEn}/bang1.jpeg`, `${baseEn}/bang2.jpeg`, `${baseEn}/bang3.jpeg`, `${baseEn}/bang4.jpeg`] },
    { name: 'Обезвредить', description: '', links: [`${baseEn}/defuse1.jpeg`, `${baseEn}/defuse2.jpeg`, `${baseEn}/defuse3.jpeg`, `${baseEn}/defuse4.jpeg`, `${baseEn}/defuse5.jpeg`, `${baseEn}/defuse6.jpeg`] },
    { name: 'Нет', description: '', links: [`${baseEn}/no1.jpeg`, `${baseEn}/no2.jpeg`, `${baseEn}/no3.jpeg`, `${baseEn}/no4.jpeg`, `${baseEn}/no5.jpeg`] },
    { name: 'Атаковать', description: '', links: [`${baseEn}/attack1.png`, `${baseEn}/attack2.png`, `${baseEn}/attack3.png`, `${baseEn}/attack4.png`] },
    { name: 'Пропустить', description: '', links: [`${baseEn}/skip1.jpeg`, `${baseEn}/skip2.jpeg`, `${baseEn}/skip3.jpeg`, `${baseEn}/skip4.jpeg`] },
    { name: 'Одолжение', description: '', links: [`${baseEn}/favor1.jpeg`, `${baseEn}/favor2.jpeg`, `${baseEn}/favor3.jpeg`, `${baseEn}/favor4.jpeg`] },
    { name: 'Перемешать', description: '', links: [`${baseEn}/mix1.jpeg`, `${baseEn}/mix2.jpeg`, `${baseEn}/mix3.jpeg`, `${baseEn}/mix4.jpeg`] },
    { name: 'Заглянуть в будущее', description: '', links: [`${baseEn}/future1.jpeg`, `${baseEn}/future2.jpeg`, `${baseEn}/future3.jpeg`, `${baseEn}/future4.jpeg`] },
    { name: 'Котенок', description: '', links: [`${baseEn}/tacocat.jpeg`, `${baseEn}/tacocat.jpeg`, `${baseEn}/tacocat.jpeg`, `${baseEn}/tacocat.jpeg`] },
    { name: 'Котенок', description: '', links: [`${baseEn}/rainbowcat.jpeg`, `${baseEn}/rainbowcat.jpeg`, `${baseEn}/rainbowcat.jpeg`, `${baseEn}/rainbowcat.jpeg`] },
    { name: 'Котенок', description: '', links: [`${baseEn}/potatocat.jpeg`, `${baseEn}/potatocat.jpeg`, `${baseEn}/potatocat.jpeg`, `${baseEn}/potatocat.jpeg`] },
    { name: 'Котенок', description: '', links: [`${baseEn}/meloncat.jpeg`, `${baseEn}/meloncat.jpeg`, `${baseEn}/meloncat.jpeg`, `${baseEn}/meloncat.jpeg`] },
    { name: 'Котенок', description: '', links: [`${baseEn}/beardcat.jpeg`, `${baseEn}/beardcat.jpeg`, `${baseEn}/beardcat.jpeg`, `${baseEn}/beardcat.jpeg`] },
  ],
};
